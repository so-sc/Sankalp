# Contributing to Sankalp

We appreciate your interest in contributing to Sankalp! This document outlines the steps and guidelines for contributing to this project. By following these steps, you can ensure your contribution is smoothly integrated into the project.
...
1. Navigate to the [Sankalp GitHub repository](https://github.com/so-sc/Sankalp).
...
```bash
  git clone https://github.com/YOUR_USERNAME/Sankalp.git
```
